          ...
          <div className="mt-[31px] grid grid-cols-2 gap-x-3 gap-y-[18.67px] md:grid-cols-2 md:gap-x-3 lg:mt-[36px] lg:gap-[20px] w-full">
            {skills.map((skill, index) => (
              <motion.div
                ...
                className={`bg-gradient-to-${index % 2 === 0 ? 'r' : 'l'} max-w-full lg:max-w-full to-[#FFD700] from-[#FFA500] ${index % 2 === 0 ? 'pr-0.5 pt-0.5' : 'pb-0.5 pl-0.5'}`}
              >
                <div className={`bg-[#332200] px-[20px] py-[23px] lg:h-[100px] lg:max-w-full lg:w-full lg:px-[32px] lg:py-[35px]`}>
