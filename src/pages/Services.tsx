...
const Services = () => {
    ...
    const services = [
        ...
        },
        {
            ...
            description: "Building Websites that works on every type of browser Safari, Chrome, Firefox, Brave etc.",
            icon: "🌐"
        }
    ];
                    ...
                    <div className="text-center mb-16">
                        ...
                        >
                            ...
                            <p className="text-[#a0b0b4] max-w-2xl mx-auto">
                                ...
                                developer, crafted with precision and expertise.
                            </p>
                        </motion.div>
                    </div>
                    ...
                    >
                        {services.map((service, index) => (
                            <motion.div
                                ...
                                animate={visibleStates[index] ? { scale: 1, opacity: 1, y: 0 } : { scale: 0.95, opacity: 0, y: 20 }}
                                transition={{
                                    duration: 0.5,
                                    type: "spring",
                                    stiffness: 100,
                            ...
                            >
                                ...
                                >
                                    ...
                                    {/* Bottom accent */}
                                    <div className={`h-1 w-16 bg-yellow-400 absolute bottom-0 left-6 rounded-t-lg transition-all duration-500 ${
